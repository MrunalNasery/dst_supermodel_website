...
app.get('/', async (req, res) => {
  ...
  // console.log(delhi_parameters);
	const mumbai_parameters = {Beta0:0.3,Beta1:0.12,Beta2:0.09,Gamma1:0.029,Gamma2:0.07,Delta:0.0035,Gamma_D:0.003,phi:1.0,N:1.24e7,I0:parseFloat(1/(1.24e7)),A0:1/(1.24e7),S0:(1-(1/1.24e7+1/1.24e7)),R0:0.0};
